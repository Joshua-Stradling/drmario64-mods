    ...
    if (vec != 0) {
        ...
        if (move_vec == 1) {
            ...
            for (i = 0; i < 2; i++) {
                ...
                if (temp_s5->pos_x[i] < 7 && temp_s5->pos_y[i] > 0) {
                    if (get_map_info(map, temp_s5->pos_x[i] + 1, temp_s5->pos_y[i])) {
            ...
            for (i = 0; i < 2; i++) {
                ...
                if (temp_s5->pos_x[i] > 0 && temp_s5->pos_y[i] > 0) {
                    if (get_map_info(map, temp_s5->pos_x[i] - 1, temp_s5->pos_y[i])) {
                        block_obstructing = true;
                        break;
                    }
